...
const activeBtnStyles = 'bg-red-500 text-white font-bold p-2 rounded-full w-20 ouline-none'
const notActiveBtnStyles = 'bg-primary mr-4 text-black font-bold p-2 rounded-full w-20 ouline-none'  
